...
export default function Contact() {
  ...
  return (
    <div className="bg-[#F5F0E8]">
      ...
      {/* ── Hero ──────────────────────────────────────────────────── */}
      <section className="geo-texture pt-32 pb-20 bg-[#F5F0E8] text-center">
        <div className="max-w-3xl mx-auto px-6 sm:px-8">
          ...
          <p className="font-sans text-[#1a1a18]/60 text-lg leading-relaxed">
      ...
      <section className="py-24 bg-[#EBE5D9]">
        <div className="max-w-2xl mx-auto px-6 sm:px-8 text-center">
            ...
            {[
              ...
              <div key={item.label}>
                <a
                  ...
                  className="flex flex-col sm:flex-row items-center justify-center gap-3 py-6 group transition-colors duration-200"
                >
                  <span className="text-[#1C3A2A]/60">{item.icon}</span>
                  <div className="text-center sm:text-left">
                    <p className="font-sans text-[#1a1a18]/40 text-xs uppercase tracking-widest mb-0.5">{item.label}</p>
                    <p className="font-sans text-[#1a1a18] group-hover:text-[#1C3A2A] text-base font-medium transition-colors duration-200">{item.value}</p>
                  </div>
                </a>
          ...
          <div className="flex flex-col items-center gap-3 mb-14">
            <MapPin size={16} className="text-[#1C3A2A]/55" />
            <div className="text-center">
              <p className="font-sans text-[#1a1a18]/40 text-xs uppercase tracking-widest mb-2">Location</p>
              <p className="font-sans text-[#1a1a18]/65 text-sm leading-relaxed">
          ...
          {/* Map */}
          <div className="border border-[#1C3A2A]/12 rounded overflow-hidden h-56 mb-8">
            <iframe
